package com.cleytuns.mongo.config;
...
import com.cleytuns.mongo.dto.AuthorDTO;
import com.cleytuns.mongo.dto.CommentDTO;
import com.cleytuns.mongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa viagem mano!", sdf.parse("21/03/2013"), new AuthorDTO(alex));
